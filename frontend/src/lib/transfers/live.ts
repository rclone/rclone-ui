...
import type { TransferDetail, TransferEntry, TransferredFile } from '@/server/transfers'
...
// What exists, what ran and how it ended is the server's record (`server/transfers.ts`); no
